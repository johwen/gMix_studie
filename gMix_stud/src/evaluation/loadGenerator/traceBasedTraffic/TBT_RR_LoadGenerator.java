...
public class TBT_RR_LoadGenerator extends TBT_LoadGenerator {
	
	private AnonNode client;

	// class TraceFileModel, TraceReplayClient : FlowReader, FlowSource
	
	protected TBT_RR_LoadGenerator(LoadGenerator owner) {
		super(owner);
		System.out.println("LOAD_GENERATOR (TBT): start at " +System.currentTimeMillis());
		// create client
