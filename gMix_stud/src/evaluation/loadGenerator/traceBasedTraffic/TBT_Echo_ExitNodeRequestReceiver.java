...
public class TBT_Echo_ExitNodeRequestReceiver implements ExitNodeRequestReceiver {
	...
	protected TBT_Echo_ExitNodeRequestReceiver(AnonNode anonNode) {
		this.anonNode = anonNode;
		this.settings = anonNode.getSettings();
	}
	
	
	public static TBT_Echo_ExitNodeRequestReceiver createInstance(AnonNode anonNode) {
		return new TBT_Echo_ExitNodeRequestReceiver(anonNode);
	}
